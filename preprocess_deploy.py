...
log5_postseason_fig.update_layout(title_text = 'KBO 팀별 포스트시즌 진출확률', margin_l=10, margin_r=10, margin_b=10, margin_t=50, dragmode = 'pan', plot_bgcolor='#D9F2D0')
for team, color in team_color.items():
...
opponent_postseason_fig.update_layout(title_text = 'KBO 팀별 포스트시즌 진출확률', margin_l=10, margin_r=10, margin_b=10, margin_t=50, dragmode = 'pan', plot_bgcolor='#D9F2D0')
for team, color in team_color.items():
...
future_championship_fig.update_layout(title_text = '팀 별 우승 확률 예측', margin_l=10, margin_r=10, margin_b=10, margin_t=50, plot_bgcolor='#D9F2D0')
future_postseason_fig.update_layout(title_text = '팀 별 포스트시즌 진출 확률 예측', margin_l=10, margin_r=10, margin_b=10, margin_t=50, plot_bgcolor='#D9F2D0')
